...
**
** Created: Fri Mar 23 10:56:48 2007
    ...
    : QWidget( parent, name, fl )
{
    ...
    m_playlistName_label = new QLabel( this, "m_playlistName_label" );

    NewDynamicLayout->addWidget( m_playlistName_label, 2, 1 );
    ...
    // tab order
    setTabOrder( m_name, m_cycleTracks );
    setTabOrder( m_cycleTracks, m_markHistory );
    setTabOrder( m_markHistory, m_previousIntSpinBox );
    setTabOrder( m_previousIntSpinBox, m_upcomingIntSpinBox );
}
...
void NewDynamic::languageChange()
{
    ...
    m_playlistName_label->setText( tr2i18n( "Dynamic playlist name:" ) );
    ...
    QWhatsThis::add( m_cycleTracks, tr2i18n( "Automatically remove played tracks from the playlist" ) );
