...
class AmarokConfig : public KConfigSkeleton
{
  public:
    ...
    */
    ...
    /**
      Set The most recently used scoring script
    */
    static
    void setLastScoreScript( const QString & v )
    {
      if (!self()->isImmutable( QString::fromLatin1( "LastScoreScript" ) ))
        self()->mLastScoreScript = v;
    }

    /**
      Get The most recently used scoring script
    */
    static
    QString lastScoreScript()
    {
      return self()->mLastScoreScript;
    }
