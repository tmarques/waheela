...
public:
    ...
    virtual void setVolumeRelative( int ticks );
...
public:
    ...
    virtual int loadPlaylist( const QString&  );
protected:
...
public:
    ...
    virtual bool isDirInCollection( const QString&  );
    ...
    virtual void newUniqueIdForFiles( const QStringList& list );
protected:
...
class AmarokDevicesInterface_stub : virtual public DCOPStub
{
public:
    AmarokDevicesInterface_stub( const QCString& app, const QCString& id );
    AmarokDevicesInterface_stub( DCOPClient* client, const QCString& app, const QCString& id );
    explicit AmarokDevicesInterface_stub( const DCOPRef& ref );
...
protected:
    AmarokDevicesInterface_stub() : DCOPStub( never_use ) {}
};




class AmarokMediaBrowserInterface_stub : virtual public DCOPStub
{
public:
    AmarokMediaBrowserInterface_stub( const QCString& app, const QCString& id );
    AmarokMediaBrowserInterface_stub( DCOPClient* client, const QCString& app, const QCString& id );
    explicit AmarokMediaBrowserInterface_stub( const DCOPRef& ref );
    ...
    virtual void queueList( KURL::List url );
    virtual void transfer();
    virtual void transcodingFinished( QString src, QString dest );
protected:
    AmarokMediaBrowserInterface_stub() : DCOPStub( never_use ) {}
};
